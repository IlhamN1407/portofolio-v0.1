    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="item">
                    <div class="logo">
                        <img src="{{ asset('/themes/img/logo-light.png') }}" alt="">
                    </div>
                    <div class="social">
                        <a href="{{ url('#0') }}"><i class="fab fa-facebook-f"></i></a>
                        <a href="{{ url('#0') }}"><i class="fab fa-twitter"></i></a>
                        <a href="{{ url('#0') }}"><i class="fab fa-instagram"></i></a>
                        <a href="{{ url('#0') }}"><i class="fab fa-youtube"></i></a>
                    </div>
                    <div class="copy-right">
                        <p>© 2021, Vie Template. Made with passion by <a href="{{ url('#0') }}">UI-themesZ</a>.
                        </p>
                    </div>
                </div>
            </div>
